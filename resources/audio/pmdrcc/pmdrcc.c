char scs_APVersion[]  ="1.01c";
int  si_APVersion     = 1013;
char scs_IFVersion[]  ="1.01";
int  si_IFVersion     = 1010;
char scs_f2pIFVersion[]  ="1.00";
int  si_f2pIFVersion     = 1000;

char JSign[]="@(#)JPR V.1.00c by JUD(T.Terata) at 2004/ 7/12";
char systemvarsion[]="1.01c"; /* 埋め込みバージョン情報 */
char systemdate[]="2004/11/22"; /* 埋め込み日付 */
